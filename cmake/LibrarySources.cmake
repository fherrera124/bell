...
if(NOT BELL_DISABLE_CODECS)
    ...
    if(BELL_CODEC_FLAC)
        list(APPEND BELL_SOURCES "main/audio/FlacCodec.cpp")
    endif()
endif()
if(NOT BELL_DISABLE_CONTAINERS AND BELL_CONTAINER_OGG)
    list(APPEND BELL_SOURCES "main/audio/OggContainer.cpp")
endif()
if(NOT BELL_DISABLE_CONTAINERS AND BELL_CONTAINER_MP3)
    list(APPEND BELL_SOURCES "main/audio/Mp3Container.cpp")
endif()
